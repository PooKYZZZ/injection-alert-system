        ...
        <div className="flex items-center gap-3">
          {activeFilterCount > 0 && (
            <motion.span
              ...
              animate={{ scale: [1.2, 1] }}
              className="flex h-5 min-w-[20px] items-center justify-center rounded-full bg-accent-action px-1.5 text-[10px] font-medium text-bg-page"
            >
              {activeFilterCount}
            </motion.span>
          )}
          {hasActiveFilters && (
            <button
              ...
              className="text-[11px] text-accent-action transition-colors hover:text-accent-action/80"
            >
              Clear all
            </button>
          )}
